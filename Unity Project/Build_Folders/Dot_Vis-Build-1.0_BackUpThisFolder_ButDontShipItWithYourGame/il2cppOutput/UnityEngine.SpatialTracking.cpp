...
IL_00b1:
	{
		...
		il2cpp_codegen_runtime_class_init_inline(PoseDataSource_tF08072CF4DBA9641E6AE6D1DBA1D421DA9C46858_il2cpp_TypeInfo_var);
		int32_t L_23;
		L_23 = PoseDataSource_TryGetTangoPose_m7888F2706149319572CAFA6D9C60B98C810B423C(L_22, NULL);
		V_5 = L_23;
		// if(retFlags == PoseDataFlags.NoData)
		int32_t L_24 = V_5;
	...
	{
		// return GetNodePoseData(XR.XRNode.CenterEye, out resultPose);
		Pose_t06BA69EAA6E9FAF60056D519A87D25F54AFE7971* L_26 = ___resultPose1;
		il2cpp_codegen_runtime_class_init_inline(PoseDataSource_tF08072CF4DBA9641E6AE6D1DBA1D421DA9C46858_il2cpp_TypeInfo_var);
		int32_t L_27;
		L_27 = PoseDataSource_GetNodePoseData_m3EA59F6C89E1BB6A6067FFCACFE574D25F04FB7E(2, L_26, NULL);
		V_4 = L_27;
		goto IL_010b;
	}
...
IL_00d7:
	{
		...
		Il2CppFakeBox<int32_t> L_31(TrackedPose_t42F18C811DFF8DB05CD5711439B2FD640800563D_il2cpp_TypeInfo_var, (&___poseSource0));
		String_t* L_32;
		...
		Debug_LogWarningFormat_m0D4A31935564D0FA042103C1231DBBD2ED0BC20A(_stringLiteral6A11DF976BD5EBFB477A52077A195879735F1FA0, L_30, NULL);
		// break;
		goto IL_00fb;
	}
...
IL_00fb:
	{
		// resultPose = Pose.identity;
		Pose_t06BA69EAA6E9FAF60056D519A87D25F54AFE7971* L_33 = ___resultPose1;
		il2cpp_codegen_runtime_class_init_inline(Pose_t06BA69EAA6E9FAF60056D519A87D25F54AFE7971_il2cpp_TypeInfo_var);
		Pose_t06BA69EAA6E9FAF60056D519A87D25F54AFE7971 L_34;
		L_34 = Pose_get_identity_m523758317678304723B886B84FEFC973E9FE1BBE(NULL);
...
IL_0016:
	...
	}
	{
		...
		L_5 = PoseData_get_position_mEE4843D61931F8AB21EE810CD308D74D725F2008((&V_0), NULL);
		...
		L_7 = PoseData_get_rotation_m6A15A78CF66E4D2F9E2EE9FE88BC8D89A65EB904((&V_0), NULL);
		L_6->___rotation_1 = L_7;
