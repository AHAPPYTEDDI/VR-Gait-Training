...
IL_0035:
	{
		...
		bool L_8 = ___value0;
		__this->____enableBurstCompilation_3 = L_8;
		// if (IsGlobal)
		bool L_9;
		L_9 = BurstCompilerOptions_get_IsGlobal_m8500610C2E650CFE58411EAD12DEE4F5F49C30B4_inline(__this, NULL);
		V_3 = L_9;
		bool L_10 = V_3;
		if (!L_10)
		{
	...
	}
	{
		...
		bool L_11 = ___value0;
		JobsUtility_set_JobCompilerEnabled_m7FC4478E64C86BAA36B2828E71D6A9BD08DF148A(L_11, NULL);
		...
		((BurstCompiler_t2715484E1FF256726FC4D4D8E17C35A4C8DFA2B8_StaticFields*)il2cpp_codegen_static_fields_for(BurstCompiler_t2715484E1FF256726FC4D4D8E17C35A4C8DFA2B8_il2cpp_TypeInfo_var))->____IsEnabled_0 = L_12;
	}
...
IL_001c:
	{
		...
		bool L_4 = ___value0;
		__this->____enableBurstSafetyChecks_4 = L_4;
		// if (changed)
		bool L_5 = V_0;
		V_2 = L_5;
		bool L_6 = V_2;
...
IL_000c:
	{
		...
		String_t* L_7 = V_3;
		bool L_8;
		L_8 = String_op_Equality_m0D685A924E5CD78078F248ED1726DA5A9D7D6AC0(L_7, _stringLiteral052A90A585030A2D7669CC7D2884B0D78760C742, NULL);
		if (L_8)
		{
			goto IL_0033;
		}
	}
	{
		String_t* L_9 = V_3;
		bool L_10;
		L_10 = String_op_Equality_m0D685A924E5CD78078F248ED1726DA5A9D7D6AC0(L_9, _stringLiteral79DA35A084D67D3A4C946D97765E49E456B15354, NULL);
		if (L_10)
		{
			goto IL_003b;
		}
...
IL_003b:
	{
		...
		((BurstCompilerOptions_t5F93118F305E1B0C950C6F9AF8BCA74033DA01C9_StaticFields*)il2cpp_codegen_static_fields_for(BurstCompilerOptions_t5F93118F305E1B0C950C6F9AF8BCA74033DA01C9_il2cpp_TypeInfo_var))->___ForceBurstCompilationSynchronously_1 = (bool)0;
		// break;
		goto IL_0043;
	}
...
IL_0048:
	...
	}
	{
		...
		bool L_14;
		L_14 = BurstCompilerOptions_CheckIsSecondaryUnityProcess_m71E9664A20C16109E35D186DE51D46A2868EC807(NULL);
		V_5 = L_14;
		bool L_15 = V_5;
		if (!L_15)
		{
