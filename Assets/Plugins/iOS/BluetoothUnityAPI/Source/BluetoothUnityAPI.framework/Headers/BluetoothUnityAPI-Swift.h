...
#ifndef BLUETOOTHUNITYAPI_SWIFT_H
#define BLUETOOTHUNITYAPI_SWIFT_H
...
- (int8_t)getBluetoothDeviceRssi SWIFT_WARN_UNUSED_RESULT;
...
- (nonnull instancetype)init:(NSString * _Nonnull)deviceName :(NSString * _Nonnull)deviceAddress :(int8_t)rssi OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init:(NSString * _Nonnull)deviceName uuid:(NSString * _Nonnull)uuid :(int8_t)rssi OBJC_DESIGNATED_INITIALIZER;
- (NSString * _Nonnull)getDeviceName SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)getDeviceAddress SWIFT_WARN_UNUSED_RESULT;
- (int8_t)getRssi SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC17BluetoothUnityAPI20ScanResultPeripheral")
@interface ScanResultPeripheral : NSObject
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
